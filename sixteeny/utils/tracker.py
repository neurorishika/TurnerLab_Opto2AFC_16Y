...
class ArenaTracker(object):
    ...
    def administer_reward(self):
        ...
        self.chosen_arms[self.trial_count] = self.absolute_to_relative_arm(self.current_arm, self.start_arm, self.arena_index)
        ...
        if np.random.rand() < reward_probability:
            ...
            # deliver reward
            self.controllers['led'].run_json(self.arena_index,reward_stimulus)
        pass
