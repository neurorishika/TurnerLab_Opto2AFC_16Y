...
====================================================================
    ...
    try:
        with SpinnakerCamera(
            ...
            maximum_time = 2.5 * 60 * 60  # seconds (2.5 hours)
            ...
            while experiment_ongoing:
                try:
                    ...
                    if len(rewarded) > 0:
                        output = led.run_accumulated_led_stimulus()
                        if output is not None:
                            # error occurred, end experiment
                            printer.print("Error occurred in LED controller. Ending experiment.")
                            raise Exception("Error occurred in LED controller.")
