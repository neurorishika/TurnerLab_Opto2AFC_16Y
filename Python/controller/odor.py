...
class OdorValveController(object):
    ...
    def relative_to_absolute_map(self, relative_odor_vector):
        """
        Map the relative [Current Arm, Left Arm, Right Arm] odor vector to the absolute odor vector [Arm 0, Arm 1, Arm 2].

        Variables:
            relative_odor_vector (list): The odors identifiers for arms [0/1/2, 0/1/2, 0/1/2].
        """
